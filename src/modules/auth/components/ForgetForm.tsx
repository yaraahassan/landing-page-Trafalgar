    ...
    <div className="w-full h-screen">
        ...
        <div className="ds-bg-alt h-screen flex flex-col justify-center items-center gap-6">
            ...
            <div className="relative">
                ...
                <InputForm type="email" placeholder={t("auth.forget.input-placeholder")} containerClassName="w-100" className="px-13"/>
            </div>

            <Button variant="primary" className="w-100" size="md">{t("auth.forget.btn1")}</Button>
            <div className="relative">
                <ArrowLeft className="absolute top-4 "/>
